...
#
# See https://github.com/cnr-anac/public-sites-service/ for more details.
#
...
sleep 10
docker compose exec postgres createdb -U cnr-anac public-company-sites

# Avvio del public-sites-service che si occuperà anche di popolare il db 
docker compose up -d
